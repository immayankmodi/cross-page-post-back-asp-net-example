<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PreviousPage.aspx.vb"
    Inherits="CrossPagePostBackExample.PreviousPage" %>
        ...
        <div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:LinkButton ID="lbtnPostData" runat="server" PostBackUrl="~/NextPage.aspx" Text="PostData" />
                    </td>
                </tr>
            </table>
        </div>
